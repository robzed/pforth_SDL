...
/*(float) err = CreateGlueToC( "SDL_atof", i++, C_RETURNS_FLOAT, 1); if( err < 0 ) return err;*/
...
/*(float) err = CreateGlueToC( "SDL_strtod", i++, C_RETURNS_FLOAT, 2); if( err < 0 ) return err;*/
...
/*(float) err = CreateGlueToC( "SDL_acos", i++, C_RETURNS_FLOAT, 1); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_acosf", i++, C_RETURNS_FLOAT, 1); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_asin", i++, C_RETURNS_FLOAT, 1); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_asinf", i++, C_RETURNS_FLOAT, 1); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_atan", i++, C_RETURNS_FLOAT, 1); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_atanf", i++, C_RETURNS_FLOAT, 1); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_atan2", i++, C_RETURNS_FLOAT, 2); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_atan2f", i++, C_RETURNS_FLOAT, 2); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_ceil", i++, C_RETURNS_FLOAT, 1); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_ceilf", i++, C_RETURNS_FLOAT, 1); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_copysign", i++, C_RETURNS_FLOAT, 2); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_copysignf", i++, C_RETURNS_FLOAT, 2); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_cos", i++, C_RETURNS_FLOAT, 1); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_cosf", i++, C_RETURNS_FLOAT, 1); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_exp", i++, C_RETURNS_FLOAT, 1); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_expf", i++, C_RETURNS_FLOAT, 1); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_fabs", i++, C_RETURNS_FLOAT, 1); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_fabsf", i++, C_RETURNS_FLOAT, 1); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_floor", i++, C_RETURNS_FLOAT, 1); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_floorf", i++, C_RETURNS_FLOAT, 1); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_trunc", i++, C_RETURNS_FLOAT, 1); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_truncf", i++, C_RETURNS_FLOAT, 1); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_fmod", i++, C_RETURNS_FLOAT, 2); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_fmodf", i++, C_RETURNS_FLOAT, 2); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_log", i++, C_RETURNS_FLOAT, 1); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_logf", i++, C_RETURNS_FLOAT, 1); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_log10", i++, C_RETURNS_FLOAT, 1); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_log10f", i++, C_RETURNS_FLOAT, 1); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_pow", i++, C_RETURNS_FLOAT, 2); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_powf", i++, C_RETURNS_FLOAT, 2); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_round", i++, C_RETURNS_FLOAT, 1); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_roundf", i++, C_RETURNS_FLOAT, 1); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_lround", i++, C_RETURNS_VALUE, 1); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_lroundf", i++, C_RETURNS_VALUE, 1); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_scalbn", i++, C_RETURNS_FLOAT, 2); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_scalbnf", i++, C_RETURNS_FLOAT, 2); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_sin", i++, C_RETURNS_FLOAT, 1); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_sinf", i++, C_RETURNS_FLOAT, 1); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_sqrt", i++, C_RETURNS_FLOAT, 1); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_sqrtf", i++, C_RETURNS_FLOAT, 1); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_tan", i++, C_RETURNS_FLOAT, 1); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_tanf", i++, C_RETURNS_FLOAT, 1); if( err < 0 ) return err;*/
...
/*(float) err = CreateGlueToC( "SDL_SwapFloat", i++, C_RETURNS_FLOAT, 1); if( err < 0 ) return err;*/
...
/*(params > 5) err = CreateGlueToC( "SDL_BuildAudioCVT", i++, C_RETURNS_VALUE, 7); if( err < 0 ) return err;*/
err = CreateGlueToC( "SDL_ConvertAudio", i++, C_RETURNS_VALUE, 1); if( err < 0 ) return err;
/*(params > 5) err = CreateGlueToC( "SDL_NewAudioStream", i++, C_RETURNS_VALUE, 6); if( err < 0 ) return err;*/
...
/*(params > 5) err = CreateGlueToC( "SDL_PixelFormatEnumToMasks", i++, C_RETURNS_VALUE, 6); if( err < 0 ) return err;*/
...
/*(params > 5) err = CreateGlueToC( "SDL_GetRGBA", i++, C_RETURNS_VOID, 6); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_CalculateGammaRamp", i++, C_RETURNS_VOID, 2); if( err < 0 ) return err;*/
...
/*(float) err = CreateGlueToC( "SDL_FRectEqualsEpsilon", i++, C_RETURNS_VALUE, 3); if( err < 0 ) return err;*/
...
/*(params > 5) err = CreateGlueToC( "SDL_ComposeCustomBlendMode", i++, C_RETURNS_VALUE, 6); if( err < 0 ) return err;*/
/*(params > 5) err = CreateGlueToC( "SDL_CreateRGBSurface", i++, C_RETURNS_VALUE, 8); if( err < 0 ) return err;*/
err = CreateGlueToC( "SDL_CreateRGBSurfaceWithFormat", i++, C_RETURNS_VALUE, 5); if( err < 0 ) return err;
/*(params > 5) err = CreateGlueToC( "SDL_CreateRGBSurfaceFrom", i++, C_RETURNS_VALUE, 9); if( err < 0 ) return err;*/
/*(params > 5) err = CreateGlueToC( "SDL_CreateRGBSurfaceWithFormatFrom", i++, C_RETURNS_VALUE, 6); if( err < 0 ) return err;*/
...
/*(params > 5) err = CreateGlueToC( "SDL_ConvertPixels", i++, C_RETURNS_VALUE, 8); if( err < 0 ) return err;*/
/*(params > 5) err = CreateGlueToC( "SDL_PremultiplyAlpha", i++, C_RETURNS_VALUE, 8); if( err < 0 ) return err;*/
...
/*(params > 5) err = CreateGlueToC( "SDL_CreateWindow", i++, C_RETURNS_VALUE, 6); if( err < 0 ) return err;*/
...
/*(float) err = CreateGlueToC( "SDL_SetWindowBrightness", i++, C_RETURNS_VALUE, 2); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_GetWindowBrightness", i++, C_RETURNS_FLOAT, 1); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_SetWindowOpacity", i++, C_RETURNS_VALUE, 2); if( err < 0 ) return err;*/
...
/*(params > 5) err = CreateGlueToC( "SDL_CreateCursor", i++, C_RETURNS_VALUE, 6); if( err < 0 ) return err;*/
...
/*(params > 5) err = CreateGlueToC( "SDL_GameControllerGetTouchpadFinger", i++, C_RETURNS_VALUE, 7); if( err < 0 ) return err;*/
...
/*(float) err = CreateGlueToC( "SDL_GameControllerGetSensorDataRate", i++, C_RETURNS_FLOAT, 2); if( err < 0 ) return err;*/
...
/*(float) err = CreateGlueToC( "SDL_HapticRumblePlay", i++, C_RETURNS_VALUE, 3); if( err < 0 ) return err;*/
...
/*(params > 5) err = CreateGlueToC( "SDL_UpdateYUVTexture", i++, C_RETURNS_VALUE, 8); if( err < 0 ) return err;*/
/*(params > 5) err = CreateGlueToC( "SDL_UpdateNVTexture", i++, C_RETURNS_VALUE, 6); if( err < 0 ) return err;*/
...
/*(float) err = CreateGlueToC( "SDL_RenderSetScale", i++, C_RETURNS_VALUE, 3); if( err < 0 ) return err;*/
...
/*(float) err = CreateGlueToC( "SDL_RenderLogicalToWindow", i++, C_RETURNS_VOID, 5); if( err < 0 ) return err;*/
...
/*(params > 5) err = CreateGlueToC( "SDL_RenderCopyEx", i++, C_RETURNS_VALUE, 7); if( err < 0 ) return err;*/
/*(float) err = CreateGlueToC( "SDL_RenderDrawPointF", i++, C_RETURNS_VALUE, 3); if( err < 0 ) return err;*/
err = CreateGlueToC( "SDL_RenderDrawPointsF", i++, C_RETURNS_VALUE, 3); if( err < 0 ) return err;
/*(float) err = CreateGlueToC( "SDL_RenderDrawLineF", i++, C_RETURNS_VALUE, 5); if( err < 0 ) return err;*/
...
/*(params > 5) err = CreateGlueToC( "SDL_RenderCopyExF", i++, C_RETURNS_VALUE, 7); if( err < 0 ) return err;*/
/*(params > 5) err = CreateGlueToC( "SDL_RenderGeometry", i++, C_RETURNS_VALUE, 6); if( err < 0 ) return err;*/
/*(params > 5) err = CreateGlueToC( "SDL_RenderGeometryRaw", i++, C_RETURNS_VALUE, 12); if( err < 0 ) return err;*/
...
/*(params > 5) err = CreateGlueToC( "SDL_CreateShapedWindow", i++, C_RETURNS_VALUE, 6); if( err < 0 ) return err;*/
...
/*(params > 5) err = CreateGlueToC( "TTF_OpenFontIndexDPIRW", i++, C_RETURNS_VALUE, 6); if( err < 0 ) return err;*/
...
/*(params > 5) err = CreateGlueToC( "TTF_GlyphMetrics", i++, C_RETURNS_VALUE, 7); if( err < 0 ) return err;*/
/*(params > 5) err = CreateGlueToC( "TTF_GlyphMetrics32", i++, C_RETURNS_VALUE, 7); if( err < 0 ) return err;*/
...
/*(params > 5) err = CreateGlueToC( "Mix_OpenAudioDevice", i++, C_RETURNS_VALUE, 6); if( err < 0 ) return err;*/
